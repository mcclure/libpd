...
PD_FILES = \
    ...
    pure-data/src/s_audio.c pure-data/src/s_audio_dummy.c pure-data/src/s_fileops.c pure-data/src/s_inter.c \
    pure-data/src/s_loader.c pure-data/src/s_main.c pure-data/src/s_net.c pure-data/src/s_path.c \
